...
function draw() {
  ...
  let points = font1.textToPoints(testo, text_x, text_y, font_size, {
  ...
  image(
    ...
    0,
    0,
    (img4.width / 4) * (width * 0.002),
    (img4.height / 4) * (width * 0.002)
  );
  pop();
  ...
  image(
    ...
    0,
    0,
    (img4.width / 5) * (width * 0.002),
    (img4.height / 5) * (width * 0.002)
  );
  pop();
  ...
  image(
    ...
    0,
    0,
    (img4.width / 7) * (width * 0.002),
    (img4.height / 7) * (width * 0.002)
  );
  pop();
  ...
  image(
    ...
    0,
    0,
    (img4.width / 10) * (width * 0.002),
    (img4.height / 10) * (width * 0.002)
  );
  pop();
}
